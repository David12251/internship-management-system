...
import { getDashboardSummary } from '../../api/companyApi';
    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='flex-1 p-8 md:p-10'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10'>
          ...
          <div className='bg-gradient-to-br from-cyan-500 to-cyan-600 text-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105 hover:shadow-xl'>
            <div className='flex items-center space-x-4'>
