...
// Icons from Heroicons (you can install via npm install @heroicons/react)
import {
  BriefcaseIcon,
  DocumentTextIcon,
  BuildingOfficeIcon,
    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='flex-1 p-8 md:p-10'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10'>
          ...
          <div className='bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105 hover:shadow-xl'>
          ...
          <div className='bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105 hover:shadow-xl'>
            <div className='flex items-center space-x-4'>
          ...
          {/* Total Students Card */}
          <div className='bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105 hover:shadow-xl'>
            <div className='flex items-center space-x-4'>
        ...
        <div className='bg-white p-6 rounded-xl shadow-lg'>
          ...
          <ul className='space-y-4'>
            {summary.recentActivities.map((activity, index) => (
              <li
                key={index}
                className='flex items-start space-x-3 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 rounded-r-lg transition-all hover:bg-gray-100'
              >
